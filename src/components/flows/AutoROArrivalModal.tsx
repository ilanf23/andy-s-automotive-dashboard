...
import { Camera, ScanLine, Check, Truck, User, Wrench } from "lucide-react";
...
type Phase = "scan" | "thinking" | "match" | "creating";
      ...
      {phase === "scan" && (
        <div className="py-6">
          <div className="mx-auto max-w-sm space-y-4">
            ...
            <div className="relative flex aspect-video items-center justify-center rounded-lg border-2 border-dashed border-border bg-surface/40">
