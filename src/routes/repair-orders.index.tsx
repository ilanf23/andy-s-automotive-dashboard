    ...
    >
      <div className="overflow-x-auto">
        <table className="w-full min-w-[1000px] text-sm">
          <TableHeader
            cols={[
              { id: "flag", label: "", w: "32px" },
              { id: "id", label: "RO #", w: "80px" },
              { id: "status", label: "Status", w: "150px" },
              { id: "customer", label: "Customer / Vehicle" },
              { id: "tech", label: "Tech", w: "140px" },
              { id: "advisor", label: "Advisor", w: "120px" },
              { id: "updated", label: "Last Update", align: "right", w: "110px" },
              { id: "days", label: "Days", align: "right", w: "70px" },
            ...
            {filteredRows.length === 0 ? (
              ...
              filteredRows.map((r) => (
                ...
                >
                  ...
                  <td className="px-3 py-2.5">
                    <span className="text-[11px]">{r.advisor.split(" ")[0]}</span>
                  </td>
